...
namespace Nexus.ServiceDesk.Migrations
{
    ...
    [Migration("20260111065232_Initial_PascalCase_Fix")]
    partial class Initial_PascalCase_Fix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexus.ServiceDesk.AppMenus.AppMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsEnabled")
                        .HasDatabaseName("ix_app_menus_enabled");

                    b.HasIndex("ParentId", "SortOrder")
                        .HasDatabaseName("ix_app_menus_parent_sort");

                    b.ToTable("AppMenus", (string)null);
                });

            modelBuilder.Entity("Nexus.ServiceDesk.AppMenus.AppRoleMenu", b =>
                {
                    ...
                    b.HasIndex("MenuId")
                        .HasDatabaseName("ix_arm_menu");

                    b.HasIndex("RoleId")
                        .HasDatabaseName("ix_arm_role");

                    b.ToTable("AppRoleMenus", (string)null);
                });

            modelBuilder.Entity("Nexus.ServiceDesk.RepairRequests.RepairRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ElectricianNote")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ApprovalStatus", "CreationTime")
                        .HasDatabaseName("ix_rr_approval_created_at");

                    b.HasIndex("Building", "Room")
                        .HasDatabaseName("ix_rr_location");

                    b.HasIndex("ElectricianId", "CreationTime")
                        .HasDatabaseName("ix_rr_electrician_created_at");

                    b.HasIndex("IsCancelled", "CreationTime")
                        .HasDatabaseName("ix_rr_cancelled_created_at");

                    b.HasIndex("TeacherId", "CreationTime")
                        .HasDatabaseName("ix_rr_teacher_created_at");

                    b.ToTable("RepairRequests", null, t =>
                        {
                            t.HasCheckConstraint("ck_rr_admin_required_when_decided", "\"ApprovalStatus\" = 0 OR (\"AdminId\" IS NOT NULL AND \"ApprovedAt\" IS NOT NULL)");
            ...
            modelBuilder.Entity("Nexus.ServiceDesk.AppMenus.AppMenu", b =>
                {
                    b.HasOne("Nexus.ServiceDesk.AppMenus.AppMenu", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Nexus.ServiceDesk.AppMenus.AppRoleMenu", b =>
                {
                    b.HasOne("Nexus.ServiceDesk.AppMenus.AppMenu", "Menu")
                        .WithMany()
