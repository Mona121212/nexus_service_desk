...
namespace Nexus.ServiceDesk.Migrations
{
    /// <inheritdoc />
    public partial class Initial_PascalCase_Fix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RequestNo = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    ...
                    ElectricianId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    ElectricianNote = table.Column<string>(type: "text", nullable: true),
                    QuotedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ...
                    AdminDecisionNote = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_rr_admin_required_when_decided", "\"ApprovalStatus\" = 0 OR (\"AdminId\" IS NOT NULL AND \"ApprovedAt\" IS NOT NULL)");
                    table.CheckConstraint("ck_rr_approval_status", "\"ApprovalStatus\" IN (0, 1, 2)");
                    table.CheckConstraint("ck_rr_cancel_vs_approve", "NOT (\"IsCancelled\" = true AND \"ApprovalStatus\" = 1)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRoleMenus", x => new { x.RoleId, x.MenuId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_app_menus_enabled",
                table: "AppMenus",
                column: "IsEnabled");

            migrationBuilder.CreateIndex(
                name: "ix_app_menus_parent_sort",
                table: "AppMenus",
                columns: new[] { "ParentId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_AppMenus_Code",
                table: "AppMenus",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairRequests_RequestNo",
                table: "RepairRequests",
                column: "RequestNo",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_rr_approval_created_at",
                table: "RepairRequests",
                columns: new[] { "ApprovalStatus", "CreationTime" });

            migrationBuilder.CreateIndex(
                name: "ix_rr_cancelled_created_at",
                table: "RepairRequests",
                columns: new[] { "IsCancelled", "CreationTime" });

            migrationBuilder.CreateIndex(
                name: "ix_rr_electrician_created_at",
                table: "RepairRequests",
                columns: new[] { "ElectricianId", "CreationTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_rr_teacher_created_at",
                table: "RepairRequests",
                columns: new[] { "TeacherId", "CreationTime" });
        }
